...
type RuneDetailsScreenRouteProp = RouteProp<RootStackParamList, "RuneDetails">;
type RuneDetailsScreenNavigationProp = StackNavigationProp<
  RootStackParamList,
  "RuneDetails"
>;

type Props = {
  route: RuneDetailsScreenRouteProp;
  navigation: RuneDetailsScreenNavigationProp;
};

const RuneDetailsScreen: React.FC<Props> = ({ route }) => {
...
export default RuneDetailsScreen;
